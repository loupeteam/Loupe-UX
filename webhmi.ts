...
//-----------------------------------------------------
class MachineClass {
	constructor(options: Machine_Options) {
		var thisMachine;
	...
	setDeepValue<Type>(obj:object, property:(string|Array<string>), value:Type):Type {
		...
		if (prop.length > 1) {
			...
			if (startArrayIndex === -1) {
				...
				return this.setDeepValue(obj[e], prop, value);
			} else {
				...
				return this.setDeepValue(obj[e][i], prop, value);
			}
	...
	getDeepValue(obj:object, property:(string|Array<string>)) {
		...
		if (prop.length > 1) {
			...
			if (startArrayIndex === -1) {
				...
				return this.getDeepValue(obj[e], prop);
			} else {
				i = parseInt(e.substring(startArrayIndex + 1), 10);
				e = e.substring(0, startArrayIndex);
				type = Object.prototype.toString.call(obj[e]);
				...
				return this.getDeepValue(obj[e][i], prop);
			}
	...
	// Return the object that was set
	value(name:(string|Array<string>), setValue?:(undefined|null)):any;
	value<T>(name:(string|Array<string>), setValue:T):T;
	value(name, setValue) {
		if (setValue !== undefined && setValue !== null) {
			return this.setDeepValue(this, name, setValue);
		} else {
			return this.getDeepValue(this, name);
		}
	}
	...
	WebSocketConnection(context, settings) {
...
// var m = new MachineClass({})
// var n:number = 1
// var num = m.value('', n)
/*
 * @param {Machine_Options} options 
 */
var Machine = function (options:Machine_Options) {
	'use strict';
...
var jsonStringifyDeepProperty = function (obj:object, property:(string|Array<string>)):string {
...
var WEBHMI = {
	version: version,
	Machine: Machine,
	jsonStringifyDeepProperty: jsonStringifyDeepProperty,
